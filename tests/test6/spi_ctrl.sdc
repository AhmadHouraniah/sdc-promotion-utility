...
# INTERNAL DEBUG CONSTRAINTS - These should be ignored since not connected to top I/O
set_input_delay -clock core_domain -max 0.5 [get_ports debug_enable]
set_input_delay -clock core_domain -min 0.1 [get_ports debug_enable]
set_output_delay -clock core_domain -max 1.0 [get_ports debug_status[0]]
set_output_delay -clock core_domain -min 0.2 [get_ports debug_status[0]]
set_output_delay -clock core_domain -max 1.0 [get_ports debug_status[1]]
set_output_delay -clock core_domain -min 0.2 [get_ports debug_status[1]]
